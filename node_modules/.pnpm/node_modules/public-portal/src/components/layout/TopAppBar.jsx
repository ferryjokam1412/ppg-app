  ...
  return (
    <header className="bg-white w-full border-b border-outline-variant shadow-sm sticky top-0 z-50">
      <div className="flex justify-between items-center px-margin-mobile md:px-margin-desktop max-w-container-max mx-auto h-20 transition-all duration-200">
        ...
        {/* DIUBAH: Menggunakan tag <a> dengan href="/admin" agar Vercel routing mengambil alih */}
        <a 
          href="/admin" 
          className="font-label-md text-sm bg-primary text-on-primary px-6 py-2 rounded-full hover:bg-primary-container transition-colors shadow-sm cursor-pointer inline-flex items-center justify-center no-underline"
        >
          Login
        </a>
      </div>
